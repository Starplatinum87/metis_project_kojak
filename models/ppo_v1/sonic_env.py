...
def make_env(env_idx):
    ...
    env = make(game=dicts[env_idx]['game'], state=dicts[env_idx]['state'], bk2dir='./bk2dir/m1')#, bk2dir="./records")#record='/tmp')

     # Use Monitor to record
    #env = gym.wrappers.Monitor(env, "/Users/starplatinum87/Google Drive/DATA_SCIENCE/METIS/METIS_BOOTCAMP/Projects/Project_5_Kojak/sonic/ppo/v0/recording/m250vid", force=True)
