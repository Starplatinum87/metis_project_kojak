...
def learn(policy,
    ...
    load_path = "/Users/starplatinum87/Google Drive/DATA_SCIENCE/METIS/METIS_BOOTCAMP/Projects/Project_5_Kojak/sonic/ppo/v0/models/m250/model.ckpt"
    ...
    for update in range(1, nupdates+1):
        ...
        if update % log_interval == 0 or update == 1:
            with open("/Users/starplatinum87/Google Drive/DATA_SCIENCE/METIS/METIS_BOOTCAMP/Projects/Project_5_Kojak/sonic/ppo/v0/data/loss_dict_"+str(update)+".pkl", 'wb') as f:
        ...
        if update % log_interval == 0 or update == 1:
            ...
            savepath = "/Users/starplatinum87/Google Drive/DATA_SCIENCE/METIS/METIS_BOOTCAMP/Projects/Project_5_Kojak/sonic/ppo/v0/models/m" + str(update) + "/model.ckpt"
            model.save(savepath)
...
def play(policy, env, update):
    ...
    # Load the model
    load_path = "./models/m1/model.ckpt"
    print(load_path)
